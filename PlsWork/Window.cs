...
namespace PlsWork
{
    ...
    public class Window : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            _shader = new Shader("E:\\Work\\TKTuts\\PlsWork\\shader.vert", "E:\\Work\\TKTuts\\PlsWork\\shader.frag");
            _shader.Use();

            _texture = new Texture("E:\\Work\\TKTuts\\PlsWork\\container.png");
            _texture.Use();

            _texture2 = new Texture("E:\\Work\\TKTuts\\PlsWork\\awesomeface.png");
            ...
            _projection = Matrix4.CreateOrthographicOffCenter(0, 800, 0, 600, 0.1f, 100);
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            // Same example with a little clearer code
            var model = Matrix4.Identity;
            model *= Matrix4.CreateScale(100, 100, 1);
            model *= Matrix4.CreateRotationZ((float)MathHelper.DegreesToRadians(_time));
            model *= Matrix4.CreateTranslation(new Vector3(300, 400, 0));
